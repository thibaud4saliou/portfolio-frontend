...
export default async function PolitiqueConfidentialite() {
  ...
  return (
    <div className="max-w-4xl mx-auto pt-24 pb-24 px-6 md:px-12 min-h-screen">
      <h1 className="text-3xl font-bold uppercase tracking-widest text-white mb-12 border-b border-gray-900 pb-6">Politique de Confidentialité (RGPD)</h1>
      <div className="text-gray-300 whitespace-pre-line leading-relaxed font-light">
        {settings.rgpd_text || "Politique de confidentialité à renseigner dans l'espace administrateur."}
      </div>
    </div>
  );
}